            ...
            <div className={`forms-grid ${mode}`}>
              <section className="form-section signin-section">
                ...
                <form onSubmit={onSignIn}>
                  ...
                  <a href="#" className="link-forgot" onClick={(event) => (isLoggingIn || isRegistering) && event.preventDefault()}>Forgot Password?</a>
                ...
                <form onSubmit={onSignUp}>
                  <label className="input-field">
                    ...
                    <input
                      ...
                      onChange={(event) => onSignUpFullNameChange(event.target.value)}
                    />
                  </label>
                  <label className="input-field">
                    <EmailIcon />
